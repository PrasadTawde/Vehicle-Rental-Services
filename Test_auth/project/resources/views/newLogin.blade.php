                        ...
                        <li class="dropdown">
                            ...
                            <div class="dropdown-menu">
                                <ul> 
                                    ...
                                    <li><a class="dropdown-item nav-link nav_item active" href="login.html">Login</a></li>
...
<form method="POST" class="user" action="{{ route('login') }}">
            @csrf                    
                            ...
                            <div class="form-group">
                                            <input type="email" class="form-control " name="email" :value="old('email')" required autofocus id="email" aria-describedby="emailHelp"placeholder="Enter Email Address...">
                        ...
                        <div class="text-center">
                                        <a class="form-note text-center" href="{{ route('password.request') }}">Forgot Password?</a>
                                    </div>
                                    <div class="text-center">
                                        <a class="form-note text-center" href="{{ route('register') }}">Create an Account!</a>
                                    </div>
                    </div>
                </div>
            </div>
